...
set_property PACKAGE_PIN P18      [get_ports {cmos1_i2c_sda_io}]
set_property PACKAGE_PIN V16     [get_ports {cmos1_d[9]}]
set_property PACKAGE_PIN W16     [get_ports {cmos1_d[8]}]
set_property PACKAGE_PIN R18     [get_ports {cmos1_i2c_scl_io}]
set_property PACKAGE_PIN T17     [get_ports {cmos1_d[5]}]
set_property PACKAGE_PIN W19     [get_ports {cmos1_d[3]}]
set_property PACKAGE_PIN W18     [get_ports {cmos1_d[4]}]
set_property PACKAGE_PIN W20     [get_ports {cmos1_d[6]}]
set_property PACKAGE_PIN V20     [get_ports {cmos1_d[0]}]
set_property PACKAGE_PIN P20     [get_ports {cmos1_d[7]}]
set_property PACKAGE_PIN N20     [get_ports {cmos1_d[1]}]
set_property PACKAGE_PIN U17     [get_ports {cmos1_d[2]}]
set_property PACKAGE_PIN T16     [get_ports {cmos1_pclk}]
set_property PACKAGE_PIN U20     [get_ports {cmos1_href}]
set_property PACKAGE_PIN T20     [get_ports {cmos1_vsync}]
set_property PACKAGE_PIN V15     [get_ports {cmos_rstn_tri_o[0]}]
...
set_property PACKAGE_PIN R14 [get_ports {cmos2_d[9]}]
set_property PACKAGE_PIN P14 [get_ports {cmos2_i2c_sda_io}]
set_property PACKAGE_PIN U12 [get_ports {cmos2_d[6]}]
set_property PACKAGE_PIN T12 [get_ports {cmos2_i2c_scl_io}]
set_property PACKAGE_PIN T15 [get_ports {cmos2_d[7]}]
set_property PACKAGE_PIN T14 [get_ports {cmos2_d[2]}]
set_property PACKAGE_PIN T11 [get_ports {cmos2_href}]
set_property PACKAGE_PIN T10 [get_ports {cmos2_d[8]}]
set_property PACKAGE_PIN U15 [get_ports {cmos2_d[3]}]
set_property PACKAGE_PIN U14 [get_ports {cmos_rstn_tri_o[1]}]
set_property PACKAGE_PIN P19 [get_ports {cmos2_d[4]}]
set_property PACKAGE_PIN N18 [get_ports {cmos2_d[5]}]
set_property PACKAGE_PIN R17 [get_ports {cmos2_d[1]}]
set_property PACKAGE_PIN R16 [get_ports {cmos2_d[0]}]
set_property PACKAGE_PIN P15 [get_ports {cmos2_vsync}]
set_property PACKAGE_PIN P16 [get_ports {cmos2_pclk}]
